...
| Current artifact source | W9–W11, W15, W17, W19, W23 (UI-008 multi-text-node payload reader, VAL-004 payload-budget warnings), then W24 (UI-009/UI-010/CTR-003/SKL-004 approval-clarity work), then W25 (REL-011 v0.2.1 line switch: package, `RELEASE_VERSION` and `generatorVersion` 0.2.1), cut by REL-011 on 2026-09-03 |
| Candidate ZIP | `dist/deliver-dual-audience-report-v0.2.1.zip` |
| ZIP size / SHA-256 | `1024339` bytes / `3c766e13bad7eccafa8426825c7ed9c590be3ac74e28281440e289e2aec6545f` |
...
| `design.md` | `57513f852261c058089936e83c99a1b6104537e0cf51d53b4cf4d89213817966` | `4c97ab3dd4ced8f3e96c514375ef9b799fe4351facc4fb724fe3dc0e8c058b79` |
| `task.md` | `f5e279e93bbb53ea3ce39852e3305f031429b80f6ecba75c8d4641038906346f` | `3287e29184d422f9a059bce9a2cdbbce4efacf58a7d971f1eec0cf61871f46df` |
...
npm run verify:dist
printf '%s  %s\n' \
  '3c766e13bad7eccafa8426825c7ed9c590be3ac74e28281440e289e2aec6545f' 'dist/deliver-dual-audience-report-v0.2.1.zip' \
  '9da67c25e4f901db4754032f2cf82bbd0c3980232c5e46bd59f92dac0169023b' 'dist/deliver-dual-audience-report-v0.2.1.manifest.json' \
  | shasum -a 256 -c -
```
