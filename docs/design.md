...
> - 目标发布：v0.2.1（v0.2.0 候选未打 tag，由 W25 切换到 v0.2.1 线；需求基线 spec 未变）
...
- v0.2.0 候选（`codex/v0.2.0` 止于 `3ff6509`，ZIP SHA-256 `cd103f2f452777866ac94cb1fd59b6702bae4251c7c7a19bdf7836bf5fcfdad4`）从未打 tag 或发布，其 ZIP/manifest 已从树中移除，不是回滚基线；同版本旧合同的回滚基线仅有上述 v0.1.0；
